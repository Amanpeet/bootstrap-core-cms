  ...
  ?>
    ...
    <div id="response" class="h5 pt-3 text-danger">
      ...
      if(isset($_POST['deletemon'])){
        ...
        if( $quer1 && $quer2 ){
          userlog('user_delete', "Deleted Editor with id: $id"); //record keeping
          echo "<strong>SUCCESS: Editor Deleted. Redirecting back...";
          echo '<script>window.location="users.php";</script>';
        } else{
          echo "<strong>ERROR: Editor not deleted. Please try again later.</strong>";
        }
      }
      ?>
    </div>
...
/* IF ADD MEMBER */
  ...
  ?>
  <div class="p-2 border-bottom">
    <h3> <strong>Add Editor</strong> </h3>
    <p>Write Details and Hit <strong>Add Editor</strong> on bottom. Some fields can't be changed later.</p>
  </div>
  ...
  <div id="response" class="h5 pt-3 text-danger">
    ...
    if(isset($_POST['addmon'])) {
      ...
      if( !$error ){
        ...
        $role = 'editor'; //fill role if active
        ...
        if( mysqli_num_rows($ex_query) > 0 ){
          ...
          if( $quer && $quer2 ){
            ...
            userlog('user_add', "Added new Editor with id: $last"); //record keeping
            echo "<strong class='text-success'>SUCCESS: New Editor Added Successfully.</strong>";
            // echo '<script>window.location="editors-single.php?view='.$last.'&added=1";</script>';
          } else {
            echo "<strong>ERROR: New Editor not Added. Please try again later.</strong>";
          }
  ...
  <div class="form-box p-2">
    <form id="id_card_form" name="id_card_form" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="my-4">
        ...
        <a href="editors.php" class="btn btn-dark">Cancel</a> <br><br>
      </div>
...
/* IF UPDATE MEMBER */
  ...
  <div class="p-2 border-bottom">
    <h3> <strong>Edit Editor</strong> </h3>
    ...
    if(isset($_POST['updatemon'])) {
      ...
      if( $fileserr1 || $fileserr3 ){
        ...
        if( $main_que ){
          ...
          echo "<strong class='text-success'>SUCCESS: Editor Updated. </strong>";
          ...
          if( $data_que ){
            ...
            echo "<strong class='text-success'> Editor Data also Updated.</strong>";
          } else {
            echo "<strong class='text-danger'> Editor Data Updation failed. </strong>";
          }

        } else {
          echo "<strong class='text-danger'> ERROR: Editor Updation failed. </strong>";
        }
  ...
  <div class="form-box p-2">
    <form id="updatemon_form" name="updatemon_form" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="row border-bottom mb-3">
        <div class="col-md-8">
          <div class="pt-2 pb-3">
            ...
            <a class="btn btn-primary" href="editors-single.php?view=<?php echo $fet['uid']; ?>">View</a>
            <a class="btn btn-danger" href="editors-single.php?del=<?php echo $fet['uid']; ?>">Delete</a>
          </div>
        </div>
      </div>
      ...
      <table class="table table-bordered table-striped table-sm table-responsive-md">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input type="file" class="form-control" name="file_identification" accept="image/*, .pdf, .docx, .doc" />
      ...
      <h5><strong>Editor Profile</strong></h5>
      <table class="table table-bordered table-striped table-sm table-responsive-md">
        <tbody>
          <tr>
...
/* IF VIEW MEMBER */
  ...
  ?>
      <!-- SHOW ALL ITEMS HERE -->
      <div class="p-2 border-bottom">
        <h3> <strong>View Editor</strong> </h3>
        <p>Viewing individual Editor details. Click <strong>Edit</strong> on right to modify details.</p>
      </div>
      ...
      <div class="pt-2 pl-2 h5 text-success">
        ...
        if( isset($_REQUEST['updated']) ) {
          echo "<strong>SUCCESS: Editor Details Updated Successfully.</strong>";
        } elseif( isset($_REQUEST['added']) ) {
          echo "<strong>SUCCESS: New Editor Added Successfully.</strong>";
        }
        ?>
      </div>
      ...
      <div class="row border-bottom mb-3">
        <div class="col-md-8">
          <div class="pt-2 pb-3">
            <small class="text-muted"> Created on <?php echo $datef; ?></small><br>
            <a class="btn btn-primary" href="editors-single.php?edit=<?php echo $fet['uid']; ?>">Edit this</a>
            <a class="btn btn-danger" href="editors-single.php?del=<?php echo $fet['uid']; ?>">Delete</a>
          </div>
        </div>
      </div>
