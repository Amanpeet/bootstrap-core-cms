...
<section class="page-section py-5 <?php echo $post['page_title']; ?>">
  <div class="container">
    <div class="d-block">
      ...
      if( !empty($link_actual) ){
        ...
        if( !empty($post) ){ ?>
          ...
          <div class="card card-body">
            <div class="row">
              <div class="col-lg">
                <div class="page-content p-lg-4 text-left">
...
<section class="page-section gallery-mode pt-0 pb-5">
  <div class="container">
    <div class="row g-4">
      <?php
        if( !empty($post) ){
          ...
          $media_ids_order = !empty($media_ids) ? " ORDER BY FIELD (gid, $media_ids)" : '' ;
          // $gal_sql = "SELECT * FROM gallery WHERE gal_tags LIKE '%$media_tag%' ".$media_ids_sql." ORDER BY gid ASC";
          $gal_sql = "SELECT * FROM gallery WHERE gal_tags LIKE '%$media_tag%' ".$media_ids_sql." ".$media_ids_order;
